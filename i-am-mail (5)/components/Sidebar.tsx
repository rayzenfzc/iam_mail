...
import { Mail, Calendar, Users, FileText, Send, Plus, Settings, Archive, Trash2, AlertOctagon, Clock, StickyNote, ShieldCheck, Sun, Moon, Database, Cloud } from 'lucide-react';
                  ...
                  {APP_APPS.map((item, i) => {
                   ...
                   <div className="mt-8 px-0">
                       <button 
                           ...
                           `}
                       >
                           {/* Simplified Icon Logic: Moon for any dark mode, Sun for light */}
