...
```
Client ID: REDACTED_ZOHO_CLIENT_ID
Client Secret: REDACTED_ZOHO_SECRET
...
**[🔗 Click to Authorize Zoho](https://accounts.zoho.com/oauth/v2/auth?client_id=REDACTED_ZOHO_CLIENT_ID&response_type=code&access_type=offline&scope=ZohoMail.organization.accounts.ALL,ZohoMail.organization.ALL&redirect_uri=https://iammail.cloud/auth/zoho/callback&prompt=consent)**
...
curl -X POST "https://accounts.zoho.com/oauth/v2/token" \
  ...
  -d "client_id=REDACTED_ZOHO_CLIENT_ID" \
  -d "client_secret=REDACTED_ZOHO_SECRET" \
...
ZOHO_CLIENT_SECRET=REDACTED_ZOHO_SECRET
